    ...
    if (actionBar != null) {
        ...
        logBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View vv) {
                try {
                    Intent callLogIntent = new Intent(Intent.ACTION_VIEW, android.provider.CallLog.Calls.CONTENT_URI);
                    startActivity(callLogIntent);
                } catch (Exception e) {
                    android.widget.Toast.makeText(MainActivity.this, "تعذر فتح سجل المكالمات", android.widget.Toast.LENGTH_SHORT).show();
                }
            }
        });
